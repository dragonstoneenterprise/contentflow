...
## This project: ContentFlow v2 prototype
Next.js 16 / React 19 app. No Supabase — auth-free with usage gating via `localStorage`. Deployed to Vercel.
...
## Production app: ~/Desktop/contentflow
